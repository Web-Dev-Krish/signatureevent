...
export default function About() {
  return (
    <div className="bg-[#FAFAFA] min-h-screen pt-28 pb-20 relative overflow-hidden">
      {/* Ambient Lights */}
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="border-l-2 border-[#D4AF37] pl-5">
                <h4 className="text-4xl font-serif font-bold text-slate-900 mb-1">20<span className="text-[#D4AF37]">+</span></h4>
                <p className="text-slate-600 text-xs font-bold uppercase tracking-widest">Years Experience</p>
              </div>
              <div className="border-l-2 border-[#D4AF37] pl-5">
                <h4 className="text-4xl font-serif font-bold text-slate-900 mb-1">1000<span className="text-[#D4AF37]">+</span></h4>
                <p className="text-slate-600 text-xs font-bold uppercase tracking-widest">Events Executed</p>
              </div>
            </div>
          </div>
          ...
          {[
            ...
            <motion.div 
              ...
              className={`p-10 rounded-2xl text-center flex flex-col items-center justify-center transition-all duration-500 border ${
                item.highlight 
                  ? 'bg-gradient-to-b from-white to-[#FAFAFA] border-[#D4AF37]/40 shadow-[0_0_30px_rgba(212,175,55,0.15)] transform md:-translate-y-4' 
                  : 'bg-slate-50 border-slate-200 hover:border-slate-300 hover:bg-slate-100 backdrop-blur-sm'
              }`}
            >
              <div className={`w-20 h-20 rounded-full flex items-center justify-center mb-6 shadow-xl ${
                item.highlight ? 'bg-gradient-to-br from-[#D4AF37] to-[#F3E5AB] text-white' : 'bg-[#FFFFFF] border border-[#D4AF37]/30 text-[#D4AF37]'
              }`}>
                <item.icon size={32} />
              </div>
              <h3 className="text-2xl font-serif font-bold text-slate-900 mb-4 tracking-wide">{item.title}</h3>
        ...
        <div className="relative">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-4">Our <span className="text-[#D4AF37]">Journey</span></h2>
            <p className="text-slate-600 max-w-2xl mx-auto font-light text-lg">A timeline of our most prestigious achievements and milestones.</p>
          </div>
