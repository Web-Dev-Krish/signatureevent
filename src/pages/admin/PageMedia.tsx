  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-serif font-bold text-white">Manage Page Media</h1>
      </div>
      ...
      <div className="bg-[#151515] border border-white/10 rounded-xl p-6">
        ...
        <select
          className="w-full bg-[#0B0B0B] border border-white/10 rounded p-3 text-white"
          value={selectedPage}
      ...
      <div className="bg-[#151515] border border-white/10 rounded-xl p-6">
        <h2 className="text-xl font-bold text-white mb-4">Current Media</h2>
        {pageMedia.length === 0 ? (
            ...
            {pageMedia.map(media => (
              <div key={media.id} className="group relative rounded-xl overflow-hidden bg-[#0B0B0B] border border-white/10">
                {media.media_type === 'image' ? (
                  ...
                  <div className="w-full h-40 flex items-center justify-center bg-[#0B0B0B]">
                ...
                <div className="p-2">
                  ...
                  <p className="text-xs text-gray-500">Order: {media.display_order}</p>
                </div>
              </div>
            ))}
          </div>
