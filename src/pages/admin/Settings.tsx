  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        ...
        <p className="text-slate-600">Manage your brand identity, contact details, and SEO metadata.</p>
      </div>
      ...
      <div className="flex justify-end">
        <button className="bg-[#D4AF37] text-white px-8 py-3 rounded-lg font-bold flex items-center gap-2 hover:bg-[#F3E5AB]">
